...
module.exports.copyRomToMemory = function(rom, memory) {
  ...
  if (oneProgramRomBuffer) {
    ...
    const amountCopyLow = programRomBuffer.copy(memory, offsetLow);
    const offsetHigh = memoryMap.MEMORY_OFFSET_PRGROM_HIGH.offset;
    const amountCopyHigh = programRomBuffer.copy(memory, offsetHigh);
    ...
    const offsetLow = memoryMap.MEMORY_OFFSET_PRGROM_LOW.offset;
    programRomBuffer.copy(memory, offsetLow);
  }
