...
*/
// TODO MAPPER: The mappings above are the fixed addresses from which the PPU uses to fetch data during rendering.
...
function getMirrorAddress(mode, _address) {
	...
	return 0x2000 + MirrorLookup[mode * 4 + table] * 0x0400 + offset;
...
//    const mode = mem.console.Cartridge.Mirror;
...
//    return mem.console.PPU.nameTableData[MirrorAddress(mode, address)%2048]
    ...
    return buildReturnModel((address - 0x1000) % 0xf00, 'vram');
  }
