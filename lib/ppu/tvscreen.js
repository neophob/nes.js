...
//TODO this function has a HUGE performance impact, dont know why yet (its not the max inline size)
//when i remove some lines the time per execution drops from 30ms to 15ms!
  getRenderingHints() {
