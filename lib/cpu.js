...
//    this.registerP.overflow = ((this.registerA ^ value) & (this.registerA ^ temp) & 0x80) !== 0;
//    this.registerP.overflow = !!((this.registerA ^ temp) & (value ^ (temp&0xff)) & 0x80) === 1;
//    this.registerP.overflow = !!((this.registerA ^ temp) & (value ^ temp) & 0x80) === 1;
  ...
  SBC(instruction) {
    ...
    this.calculateAdc(~subtractValue);
  }
