...
class Cpu {
  ...
  interrupt(vectorAddress) {
    ...
    debug('AAAA', this.memory.read8(0xfffc), this.memory.read8(0xfffd));
  ...
  CLI() {
    ...
    this.registerP.interrupt = false;
  }
  ...
  SBC(instruction) {
    ...
    this.registerA = (this.registerA - subtractValue - (1 - this.registerP.carry)) & 0xff;
    this.setZeroAndNegativeFlag(this.registerA);
    /*
